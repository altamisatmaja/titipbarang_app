...
class _ApiClient implements ApiClient {
  ...
  Future<ResponseSignIn> login({
    ...
    final _options = _setStreamType<ResponseSignIn>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ResponseSignIn _value;
    try {
      _value = ResponseSignIn.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ResponseSignIn> getMe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ResponseProducts> getProducts({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ResponseProducts>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResponseProducts _value;
    try {
      _value = ResponseProducts.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
